...
const mockPlans = [
  { id: 1, name: 'Plan 1', description:'DTH BILLS' },
  { id: 2, name: 'Plan 2', description: 'ELECTRICITY BILLS'},
  { id: 3, name: 'Plan 3', description: 'RECHARGE BILLS' },
  // Add more plans here...
];
...
const MobileRechargePlans = () => {
  ...
  return (
    ...
    <div className="mobile-recharge-plans">
      ...
      <h1>BILL PAYMENTS</h1>
      <br></br>
      <div className="plans-container" style={{backgroundImage:"blue"}}>
        {plans.map((plan) => (
          <Link to='/Payment'>
          <div className="plan-card" key={plan.id}>
            <h2 className="plan-name">{plan.name}</h2>
            <p className="plan-description"  style={{fontSize:"30px"}}>{plan.description}</p>
